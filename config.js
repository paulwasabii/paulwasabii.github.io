...
const init_phones = ["PaulWasabii Target","Simgot EA500 Red"],                      // Optional. Which graphs to display on initial load. Note: Share URLs will override this set
      DIR = "data/",                                // Directory where graph files are stored
      default_channels = ["L","R"],                 // Which channels to display. Avoid javascript errors if loading just one channel per phone
      default_normalization = "dB",                 // Sets default graph normalization mode. Accepts "dB" or "Hz"
      default_norm_db = 60,                         // Sets default dB normalization point
      default_norm_hz = 800,                       // Sets default Hz normalization point (500Hz is recommended by IEC)
      ...
      watermark_text = "paulwasabii.com",                 // Optional. Watermark appears behind graphs
      watermark_text2 = "pw.squig.link",                 // Optional. Watermark appears behind graphs	  
      watermark_image_url = "pw.svg",   // Optional. If image file is in same directory as config, can be just the filename
      page_title = "Squiglink by Paul Wasabii",                     // Optional. Appended to the page title if share URLs are enabled
...
const targets = [
    { type:"Preference", files:["Harman 2019v2","Oratory1990","AutoEQ","Rtings"] },
    { type:"Reviewer",   files:["Antdroid","Bad Guy","Banbeucmas","Crinacle","PaulWasabii","Precogvision","Redeyes","RikudouGoku","Super Review"] },
    { type:"Guest",    files:["Diffuse Field","Etymotic","Free Field","Innerfidelity ID"] },	
//	{ type:"Guest",    files:["Redeyes","Etymotic","Free Field","Innerfidelity ID"] },
];
...
const 
    ...
    widgets = `
        <div class="accessories-widgets">
            ...
            <div class="widget">
                <a href="https://www.youtube.com/channel/UCsplQVOhTkU0g3bHh3F9ORg"><img width="200" src="youtube.png"/></a>
            </div>
...
const linkSets = [
    {
        ...
        links: [
            ...
            {
                name: "EliseAudio",
                url: "https://soundjedi.squig.link/"
            },			
            {
                name: "HypetheSonics",
            ...
            {
                name: "tgx78",
                url: "https://tgx78.squig.link/"
            },			
            {
                name: "Vortex Reviews",
                url: "https://vortexreviews.squig.link/"
            },			
        ]
    },
    {
...
let headerLogoText = '',
    ...
    {
        name: "YouTube",
        url: "https://www.youtube.com/channel/UCsplQVOhTkU0g3bHh3F9ORg"
    },
    {
        name: "Twitter",
        url: "https://twitter.com/paulwasabii"
    }
];
